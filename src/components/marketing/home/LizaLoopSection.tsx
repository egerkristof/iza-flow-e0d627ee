...
const STEPS = [
  ...
  },
  {
    ...
    headline: "Live sessions where the instruction set builds itself.",
    line: "Your team works together in real-time collaborative sessions — mixing complex reality with existing standards. Every conversation enriches the shared methodology, so the weakest performer benefits from the strongest insight.",
    before: "Everyone brings their own context, their own prompts",
    after: "Live team sessions that compound the best knowledge automatically",
    img: loopCollaborate,
  },
  {
    key: "learn",
