...
function Slide02() {
  const above: { x: number; label: string }[] = ["SOPs","Policies","Templates","Records"].map((label: string, i: number) => ({
    x: 720 + i * 165,
    label,
  }));
  const buckets: { title: string; items: string[] }[] = [
    {
      ...
      "items": [
        "Why this approach, not the textbook one",
        "Senior practitioner rule-of-thumb",
        "Trade-offs already settled in prior work"
      ]
    },
    {
      "title": "Regulator & Client Memory",
      "items": [
        "Prior agency or client feedback on this asset",
        "Open commitments and conditions",
    ...
    },
    {
      ...
      "items": [
        "Process nuance for this case type",
        "Exception patterns and rationale",
        "Prior CAPA / lessons across the portfolio"
      ]
    },
    {
      "title": "Cross-Functional Decisions",
      "items": [
        "Strategy shifts not yet documented",
        "Sign-off thresholds and owners",
        "Live escalations and posture"
      ]
    }
  ];
    ...
    <div className="w-full h-full flex flex-col relative overflow-hidden" style={{ background: BG }}>
      ...
      <div className="relative z-20 px-28 pt-12">
        <p className="font-semibold tracking-[0.25em] uppercase mb-4" style={{ fontSize: 22, color: `hsl(${WARM})` }}>
          The Context Gap in Cross-Industry
        </p>
        ...
        <p className="font-medium" style={{ fontSize: 24, color: MUTED, lineHeight: 1.35, maxWidth: 1500 }}>
          AI doesn&apos;t miss because the model is weak. It misses because <span style={{ color: TEXT, fontWeight: 700 }}>most of how a cross-industry organization actually decides was never formally defined.</span>
        </p>
      </div>
...
const __VERTICAL_PERSONAS = [
  {
    ...
    "below": [
      "Annex-7 vs Annex-1 judgment a senior QA lead applies instantly",
  ...
  },
  {
    ...
    "below": [
      "The CEO's mid-engagement strategy shift",
      "Senior partner reframing instinct",
      "Account history not in the brief"
    ],
    "breaks": "Margin erosion. Client escalation."
  },
  {
    "id": "fs",
    ...
    "below": [
      "Client exposure profile after recent acquisition",
      "Firm's evolving risk posture",
      "Prior adjudications on this case type"
    ],
    "breaks": "Regulatory exposure. Inconsistent pricing."
  }
] as const;
    ...
    <div className="w-full h-full flex flex-col relative" style={{ background: BG }}>
      ...
      <div className="relative z-10 flex flex-col h-full px-20 pt-10 pb-8">
        <p className="font-semibold tracking-[0.25em] uppercase mb-2" style={{ fontSize: 22, color: `hsl(${TEAL})` }}>
          Where Missing Context Shows Up in regulated industries
        </p>
        ...
        <p className="mb-5" style={{ fontSize: 18, color: MUTED, maxWidth: 1500, lineHeight: 1.4 }}>
          The artifacts above the waterline are what AI sees. The Organizational Intelligence below the waterline is the expert judgment that determines whether the output is usable.
        </p>
