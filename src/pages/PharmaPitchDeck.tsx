  ...
  return (
    <div className="w-full h-full flex flex-col relative" style={{ background: BG }}>
      ...
      <div className="relative z-10 flex flex-col justify-center h-full px-[120px] pt-[90px]">
        ...
        {/* AI value + governed sets */}
        <div className="flex items-center gap-4">
          <div className="rounded-xl px-5 py-3" style={{ background: `hsl(${DARK})` }}>
            <p className="font-bold mb-1.5" style={{ fontSize: 13, color: `hsl(${ACCENT})` }}>What AI receives as context</p>
            <div className="flex gap-2">
              {["Process workflows", "Quality standards", "Decision criteria", "Reference documents", "Past approvals"].map(t => (
          ...
          <div className="rounded-xl px-5 py-3 flex-1" style={{ background: `hsl(${TEAL} / 0.06)`, border: `1px solid hsl(${TEAL} / 0.15)` }}>
            <p className="font-semibold" style={{ fontSize: 15, color: `hsl(${TEAL})` }}>
              AI accelerates, humans govern. Every AI-generated output is scoped by your standards and approved by qualified personnel before it moves forward.
            </p>
          </div>
        </div>
      </div>
