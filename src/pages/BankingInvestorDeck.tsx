...
const SLIDES = [
  ...
  { id: 4, title: "Where Missing Context Shows Up in Retail Banking", component: <Slide03 /> },
  { id: 5, title: "What Missing Context Costs in Retail Banking", component: <Slide04Cost /> },
