  ...
  return (
    <div className="min-h-screen bg-white text-foreground">
      ...
      <main className="mx-auto max-w-5xl px-5 sm:px-8 pt-10 sm:pt-16 pb-24">
        ...
        {/* Visual: three symptoms of the satcom knowledge gap */}
        <motion.div
        ...
        >
          {[
            { Icon: FileQuestion, label: "Not codified", sub: "Lives in senior ops heads" },
            { Icon: Clock, label: "Slow to onboard", sub: "6–18 months to ramp" },
            { Icon: TrendingUp, label: "Doesn't propagate", sub: "Lessons stay per satellite" },
          ].map((item) => {
