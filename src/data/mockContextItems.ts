...
export const MOCK_CONTEXT_ITEMS: MockContextItem[] = [
  { id: "ci1", title: "Enterprise Pricing Protocol", category: "PLAYBOOK", priority: "CRITICAL", security_level: "CONFIDENTIAL", action_type: "OVERRIDE", bundle_id: "b1", domain_tags: ["sales", "pricing"], trigger_intent: "pricing negotiation", content_preview: "When handling enterprise deals above $100K ARR, follow the tiered approval matrix…", last_used_at: "2h ago", version: "v2.1", created_at: "2025-12-05" },
  { id: "ci2", title: "Discovery Call Framework", category: "PROCEDURE", priority: "STANDARD", security_level: "INTERNAL", action_type: "APPEND", bundle_id: "b1", domain_tags: ["sales"], trigger_intent: "discovery call", content_preview: "Structure discovery calls using the MEDDPICC framework: Metrics, Economic Buyer…", last_used_at: "5h ago", version: "v1.4", created_at: "2025-12-10" },
  { id: "ci3", title: "Competitor Battlecard: Acme Corp", category: "KNOWLEDGE", priority: "STANDARD", security_level: "CONFIDENTIAL", action_type: "APPEND", bundle_id: "b1", domain_tags: ["sales", "competitive"], trigger_intent: "competitive deal", content_preview: "Acme Corp weaknesses: limited API integrations, no SOC2 compliance, higher TCO…", last_used_at: "1d ago", version: "v3.2", created_at: "2025-11-20" },
  { id: "ci4", title: "Never Discount Below 15%", category: "DIRECTIVE", priority: "CRITICAL", security_level: "ADMIN_ONLY", action_type: "BLOCK", bundle_id: "b1", domain_tags: ["sales", "pricing"], trigger_intent: "discount request", content_preview: "Under no circumstances should reps offer discounts below 15% without VP approval…", last_used_at: "3h ago", version: "v1.0", created_at: "2025-10-01" },
  { id: "ci5", title: "Client Onboarding Checklist", category: "PROCEDURE", priority: "STANDARD", security_level: "INTERNAL", action_type: "APPEND", bundle_id: "b2", domain_tags: ["cs", "onboarding"], trigger_intent: "new client setup", content_preview: "Week 1: Kickoff call, access provisioning. Week 2: Data migration…", last_used_at: "8h ago", version: "v2.0", created_at: "2025-11-15" },
  { id: "ci6", title: "Health Score Calculation", category: "KNOWLEDGE", priority: "STANDARD", security_level: "INTERNAL", action_type: "APPEND", bundle_id: "b2", domain_tags: ["cs"], trigger_intent: null, content_preview: "Health score = 0.3*usage + 0.25*engagement + 0.2*support_tickets + 0.25*NPS…", last_used_at: "2d ago", version: "v1.1", created_at: "2025-11-20" },
  { id: "ci7", title: "GDPR Data Handling Directive", category: "DIRECTIVE", priority: "CRITICAL", security_level: "ADMIN_ONLY", action_type: "OVERRIDE", bundle_id: "b3", domain_tags: ["legal", "compliance"], trigger_intent: "data processing", content_preview: "All PII must be encrypted at rest and in transit. Retention period: 36 months max…", last_used_at: "4d ago", version: "v3.0", created_at: "2025-10-20" },
  { id: "ci8", title: "Quarterly Audit Procedure", category: "PROCEDURE", priority: "STANDARD", security_level: "CONFIDENTIAL", action_type: "APPEND", bundle_id: "b3", domain_tags: ["compliance"], trigger_intent: null, content_preview: "Run compliance audit every Q1/Q3. Checklist: access logs, data retention…", last_used_at: "2w ago", version: "v2.5", created_at: "2025-09-15" },
  { id: "ci9", title: "Code Review Standards", category: "PROCEDURE", priority: "STANDARD", security_level: "INTERNAL", action_type: "APPEND", bundle_id: "b4", domain_tags: ["engineering"], trigger_intent: "code review", content_preview: "All PRs require 2 approvals. Security-sensitive changes require CODEOWNER review…", last_used_at: "6h ago", version: "v1.2", created_at: "2026-01-10" },
  { id: "ci10", title: "Preferred Communication Style", category: "PREFERENCE", priority: "STANDARD", security_level: "INTERNAL", action_type: "APPEND", bundle_id: null, domain_tags: ["general"], trigger_intent: null, content_preview: "Use concise, bullet-point format. Avoid jargon. Lead with the recommendation…", last_used_at: "1h ago", version: "v1.0", created_at: "2026-01-20" },
  { id: "ci11", title: "Proposal Template v3", category: "PLAYBOOK", priority: "STANDARD", security_level: "INTERNAL", action_type: "APPEND", bundle_id: "b1", domain_tags: ["sales"], trigger_intent: "proposal creation", content_preview: "Use the standard 8-section format: Exec Summary, Problem Statement, Solution…", last_used_at: "12h ago", version: "v3.0", created_at: "2025-12-15" },
  { id: "ci12", title: "Escalation Playbook", category: "PLAYBOOK", priority: "CRITICAL", security_level: "CONFIDENTIAL", action_type: "OVERRIDE", bundle_id: "b2", domain_tags: ["cs", "support"], trigger_intent: "customer escalation", content_preview: "P1: Respond within 1h, VP notified. P2: Respond within 4h, Manager loop-in…", last_used_at: "3d ago", version: "v1.5", created_at: "2025-11-25" },
];
