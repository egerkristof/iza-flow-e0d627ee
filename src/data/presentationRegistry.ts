...
const BridgeDeck = lazy(() => import("@/pages/BridgeDeck"));
const TechDDDeck = lazy(() => import("@/pages/TechDDDeck"));
const ImpactDeck = lazy(() => import("@/pages/ImpactDeck"));
...
const SeedPitchDeckInvestor = lazy(() => import("@/pages/SeedPitchDeckInvestor"));
const SalesDeckAIAdoption = lazy(() => import("@/pages/SalesDeckAIAdoption"));
const InsuranceDeck = lazy(() => import("@/pages/InsuranceDeck"));
const InsuranceUnderwritingDeck = lazy(() => import("@/pages/InsuranceUnderwritingDeck"));
const ConsultingDeck = lazy(() => import("@/pages/ConsultingDeck"));
const ConsultingTrainingDeck = lazy(() => import("@/pages/ConsultingTrainingDeck"));
const PharmaPitchDeck = lazy(() => import("@/pages/PharmaPitchDeck"));
const LinkedInImageCard = lazy(() => import("@/pages/LinkedInImageCard"));
const LifecycleInvestorDeck = lazy(() => import("@/pages/LifecycleInvestorDeck"));
const LifecycleInvestorDeckV2 = lazy(() => import("@/pages/LifecycleInvestorDeckV2"));
const LifecycleInvestorDeckV3 = lazy(() => import("@/pages/LifecycleInvestorDeckV3"));
const LCVInvestorDeck = lazy(() => import("@/pages/LCVInvestorDeck"));
const AuditOffer = lazy(() => import("@/pages/offers/AuditOffer"));
const AECInvestorDeck = lazy(() => import("@/pages/AECInvestorDeck"));
const PharmaInvestorDeck = lazy(() => import("@/pages/PharmaInvestorDeck"));
const SpaceDeck = lazy(() => import("@/pages/SpaceDeck"));
const SpaceBrief = lazy(() => import("@/pages/SpaceBrief"));
const SatcomDeck = lazy(() => import("@/pages/SatcomDeck"));
const SatcomBrief = lazy(() => import("@/pages/SatcomBrief"));
const MADeck = lazy(() => import("@/pages/MADeck"));
const StrategyOfficeDeck = lazy(() => import("@/pages/StrategyOfficeDeck"));
const PharmaBrief = lazy(() => import("@/pages/PharmaBrief"));
const BankingSalesDeck = lazy(() => import("@/pages/BankingSalesDeck"));
const AutomotiveInvestorDeck = lazy(() => import("@/pages/AutomotiveInvestorDeck"));
const SpaceDefenseHoldingsDeck = lazy(() => import("@/pages/SpaceDefenseHoldingsDeck"));
const SpaceDefenseHoldingsBrief = lazy(() => import("@/pages/SpaceDefenseHoldingsBrief"));
const ResearchBrief = lazy(() => import("@/pages/ResearchBrief"));
const ResearchDeck = lazy(() => import("@/pages/ResearchDeck"));
