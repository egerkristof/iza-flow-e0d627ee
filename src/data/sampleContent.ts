...
### 1.1 — Inbound Lead Assessment Playbook
...
**Directive:** No enterprise lead may sit uncontacted for more than 6 business hours. Response time is the single strongest predictor of conversion at the top of funnel.

**Directive:** SDRs must never discuss pricing or custom terms during initial qualification. Redirect all pricing conversations to the assigned Account Executive.

**Knowledge:** Our historical conversion data shows that leads contacted within 2 hours convert at 3.2x the rate of leads contacted after 24 hours. ICP-fit leads that pass qualification convert to closed-won at 34% compared to 8% for non-ICP leads.

---

## Stage 2: Discovery & Solution Fit

### 2.1 — Structured Discovery Playbook
...
**Principle:** We sell outcomes, not features. Every proposal must articulate the measurable business impact in the client's language, not ours. If we can't quantify the value, we haven't completed discovery.

**Knowledge:** Deals with an identified champion close at 2.4x the rate of deals without one. Deals with a documented compelling event close 40% faster on average.

---

## Stage 3: Proposal & Negotiation

### 3.1 — Proposal Review Playbook
...
**Directive:** Discounts exceeding 15% from list price require written VP Sales approval. Discounts exceeding 25% require CRO approval. No exceptions.

**Directive:** All proposals must include a "Why Now" section that references the client's specific compelling events and the cost of inaction.

**Principle:** A proposal is a decision document, not a product brochure. Every page should move the client closer to a yes or surface an objection we can address. Remove anything that doesn't serve one of these two purposes.`,
  },
  {
    id: "sales-pipeline-review",
    title: "Quarterly Pipeline Review Playbook",
    subtitle: "How sales leadership reviews, stress-tests, and forecasts the enterprise pipeline",
    domain: "Sales",
    icon: "trending-up",
    wordCount: 750,
    content: `# Quarterly Pipeline Review Playbook

## Overview
This playbook governs how sales leadership conducts quarterly pipeline reviews to produce accurate forecasts, identify at-risk deals, and allocate resources for maximum revenue impact.
...
**Directive:** Pipeline coverage must maintain a minimum 3x ratio to quota. If coverage drops below 3x for any rep or territory, an immediate pipeline generation sprint is triggered.

**Knowledge:** Historical analysis shows our stage-weighted pipeline accuracy is 72%. Deals in "Verbal Commit" stage close at 85%, "Proposal Sent" at 45%, "Discovery" at 22%, and "Qualification" at 12%.

---

## Review Execution

### Deal-by-Deal Review Playbook
...
**Directive:** Forecast categories must be used consistently: Commit (>90% confidence), Best Case (60-90%), Pipeline (30-60%), Upside (<30%). Any deal in "Commit" without a signed mutual action plan must be downgraded.

**Principle:** An accurate forecast is more valuable than an optimistic one. We reward precision, not padding. A rep who consistently forecasts accurately earns more trust and autonomy than one who always overestimates.
...
**Knowledge:** Teams that conduct structured pipeline reviews with documented follow-through outperform teams with informal reviews by 23% on quota attainment. The single highest-impact action is consistent stage-gate enforcement.`,
  },
  {
...
**Directive:** Every strategic account must have a documented account plan updated quarterly. Accounts without a current plan cannot receive executive engagement or premium support resources.

**Knowledge:** Accounts with active expansion plans grow at 28% annually compared to 4% for accounts managed reactively. The average strategic account has 3.2 unexplored business units that represent expansion opportunities.

---

## Relationship Management

### Executive Alignment Playbook
...
**Principle:** Relationships compound. An executive relationship built over 3 years of consistent engagement is virtually un-displaceable by competitors. We invest in relationships before we need them, not when renewal is at risk.

**Directive:** Never surprise a client executive. If there's a service issue, pricing change, or strategic shift, the client's executive sponsor hears it from our executive first — before it reaches their operational team.

---

## Expansion Strategy

### Whitespace Mapping & Cross-Sell Playbook
...
**Principle:** Land and expand is not a metaphor — it's the entire growth engine. Every successful deployment should immediately trigger the question: who else in this organisation would benefit from what we just delivered?`,
  },
...
### 1.1 — Request & Initial Screening Playbook
...
**Directive:** All vendor engagements exceeding €50K annual spend must go through competitive evaluation with a minimum of 3 vendors unless a sole-source justification is approved by the CFO.

**Directive:** No department may engage a vendor or sign any agreement — including free trials with data access — without Procurement's written acknowledgment. Shadow procurement creates unmanaged risk.

**Knowledge:** Our average vendor onboarding takes 22 business days for standard track and 45 days for complex/high-value vendors. The most common delay is incomplete vendor documentation — providing a clear checklist upfront reduces cycle time by 35%.

---

## Stage 2: Due Diligence & Approval

### 2.1 — Risk Assessment Playbook
...
**Directive:** Vendors scoring below 60/100 on the security assessment may not be onboarded regardless of business need. No exceptions without CISO written approval and a documented remediation timeline.

**Principle:** Vendor risk is our risk. When a vendor fails, our customers don't blame the vendor — they blame us. Every vendor in our ecosystem extends our attack surface and our reputation.

---

## Stage 3: Contracting & Onboarding

### 3.1 — Contract Execution Procedure
...
### 3.2 — Vendor Integration Playbook
...
**Knowledge:** Vendors with structured onboarding and a designated relationship manager have 45% fewer service incidents in the first year compared to vendors managed ad-hoc. Quarterly performance reviews reduce contract disputes by 60%.`,
  },
  {
...
**Directive:** When in doubt, classify up, not down. It is always better to over-respond and downgrade than to under-respond and escalate late. Re-classification can happen at any point during the response.
...
**Directive:** Customer-facing communications during a SEV-1 incident must be reviewed by the Communications Lead before sending. Never speculate on root cause in external communications. State what happened, what's affected, and what we're doing — not why it happened, until confirmed.

**Knowledge:** Our historical data shows that 68% of SEV-1 incidents are resolved within the 1-hour target. The most common root cause categories are: deployment-related (35%), infrastructure (28%), third-party dependency (22%), and data-related (15%).
...
**Principle:** We practice blameless post-mortems. Individuals don't cause incidents — systems do. If a single person's mistake can cause a customer-facing outage, that's a system design problem, not a people problem. Our job is to build systems that are resilient to human error.

**Directive:** All SEV-1 and SEV-2 action items from PIRs must be completed within 30 days. Overdue items are automatically escalated to the VP of Engineering. PIR action items take priority over feature work.

**Knowledge:** Teams that complete all PIR action items within 30 days see a 52% reduction in repeat incidents. The average number of action items per SEV-1 PIR is 4.7. The most impactful category of improvements is monitoring and alerting enhancements.`,
  },
  {
...
### Annual Audit Calendar Playbook
...
**Directive:** No team may decline or postpone a scheduled audit without Quality Director approval. Postponements must be rescheduled within 30 days of the original date.

**Knowledge:** Our audit programme covers 14 delivery teams and 32 distinct process areas. Historical data shows that teams audited twice yearly improve their quality scores 40% faster than those audited once.

---

## Audit Execution

### Audit Fieldwork Playbook
...
**Directive:** All audit findings must be supported by evidence. Opinions and impressions are documented separately from factual findings. The audit report must distinguish between non-conformities (process violations), observations (improvement opportunities), and good practices (worth sharing across teams).

**Principle:** Audits exist to help teams improve, not to punish them. The tone is collaborative and constructive. A well-conducted audit should leave the team feeling supported and clear on their improvement path, not defensive.

---

## Reporting & Follow-Up

### Findings & Remediation Procedure
...
**Directive:** Critical non-conformities (rated 1 on the 5-point scale) trigger an immediate remediation plan due within 5 business days. The process area remains under enhanced monitoring until the follow-up audit confirms resolution.`,
  },
...
### Monthly Close Timeline Playbook
...
**Directive:** The close must be completed by Day 7. Any delays must be reported to the CFO immediately with root cause and recovery plan. Consistently late closes (2+ months) trigger a process review.

**Directive:** All manual journal entries above €10,000 require dual authorisation. Journal entries above €50,000 require Controller approval. No journal entry may be posted without supporting documentation attached in the ERP.

**Knowledge:** Our target close timeline is 7 business days. Current average is 8.2 days. Best-in-class for our industry is 5 days. The most common close delays are: late invoice submissions (40%), intercompany reconciliation discrepancies (25%), and revenue recognition complexities (20%).

---

## Reconciliation Standards

### Account Reconciliation Playbook
...
**Principle:** The balance sheet tells the truth about our business. Every number on it must be defensible, documented, and reconciled. A clean balance sheet is the foundation of trustworthy reporting.

---

## Management Reporting

### Reporting Package Procedure
...
**Knowledge:** Our management reporting package includes 14 core KPIs tracked monthly. The metrics with the highest executive attention are: MRR growth, gross margin, cash runway, customer acquisition cost, and employee headcount vs. plan.

**Directive:** Financial reports must never be shared externally without CFO approval. Draft reports must be clearly watermarked as "DRAFT — CONFIDENTIAL" until final sign-off.`,
  },
  {
...
**Directive:** Budget submissions without clearly stated assumptions are returned for revision. Every line item above €25K must include a business justification linking to a strategic objective or operational necessity.

**Principle:** A budget is a promise. It reflects our priorities and our discipline. Teams that consistently operate within budget while delivering results earn greater autonomy in subsequent cycles. Teams that regularly overrun lose discretionary spending authority.

---

## In-Year Modifications

### Budget Change Request Procedure
...
**Directive:** Splitting a large expense into smaller requests to avoid approval thresholds is a violation of our financial controls policy. FP&A monitors for patterns of split spending and escalates to the CFO.

---

## Variance Analysis

### Monthly Variance Review Playbook
...
**Principle:** Variance analysis is not about assigning blame — it's about improving our ability to predict and plan. Accurate forecasting is a skill that improves with practice and honest reflection on where our assumptions were wrong.`,
  },
  {
...
**Directive:** No investment above €500K may proceed without formal Investment Committee screening. Verbal agreements, letters of intent, or exclusivity arrangements require IC Chair approval before execution.

**Knowledge:** Our historical acceptance rate at screening is 35%. Of deals that proceed to full diligence, 60% receive final IC approval. The most common decline reasons are: strategic misalignment (40%), valuation concerns (30%), and integration complexity (20%).

---

## Full Due Diligence

### Diligence Execution Playbook
...
3. Financial diligence must include: quality of earnings analysis, normalised EBITDA bridge, working capital analysis, debt-like items review, and independent financial model built from first principles.
4. Commercial diligence must validate: total addressable market sizing, competitive positioning, customer concentration risk, and revenue sustainability.
5. Conduct management presentations — minimum 2 sessions focused on strategy, operations, and forward outlook.
6. Commission third-party reports as needed: market studies, technical assessments, environmental reviews.

**Directive:** The Diligence Lead must never rely solely on the target's representations. All material claims must be independently verified through document review, customer references, or third-party analysis.

**Directive:** All diligence findings, including negative findings, must be documented in the final IC Memo. Omitting or downplaying adverse findings is a serious breach of our investment process.

**Principle:** The purpose of due diligence is not to confirm what we want to believe — it's to discover what we need to know. The best diligence process is the one that surfaces the deal-killing fact before we commit capital, not after.

---

## Decision & Documentation

### Investment Committee Presentation Procedure
1. Diligence Lead prepares the IC Memo (maximum 20 pages plus appendices) including: executive summary, investment thesis, valuation analysis, key risks with mitigants, and clear recommendation.
2. The IC Memo must include a dedicated "What Would Make Us Wrong" section with at least 3 falsifiable hypotheses.
3. Include scenario analysis: base case, upside case, and downside case with probability-weighted expected returns.
4. Present to the full IC at a dedicated session — minimum 90 minutes for M&A, 60 minutes for other investment types.
5. IC votes with a clear outcome: Approve, Approve with Conditions, Defer for Additional Diligence, or Decline.

**Knowledge:** Deals where the IC identified and stress-tested the top 3 risks during diligence generated 35% higher returns than deals with incomplete risk assessment. The strongest predictor of investment success is the rigour of the bear case analysis, not the conviction in the bull case.

**Principle:** We value intellectual honesty above conviction. Changing your mind when confronted with new evidence is not weakness — it's the hallmark of disciplined investing. The most expensive mistakes in our industry come from commitment bias, not from missed opportunities.`,
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    subtitle: "90-day structured programme for integrating new hires from Day 1 to full productivity",
    domain: "People & HR",
    icon: "users",
    wordCount: 850,
...
## Overview
This programme defines the structured 90-day onboarding journey for all new employees, from pre-arrival preparation through to full productivity. It ensures every new hire feels welcomed, equipped, and clear on expectations.

---

## Pre-Arrival Phase (T-14 to Day 0)

### Pre-Arrival Preparation Playbook
1. Hiring Manager completes the New Hire Setup Checklist within 48 hours of offer acceptance: equipment order, system access requests, workspace assignment, and buddy assignment.
2. IT provisions laptop, email, and core system access at least 3 business days before start date.
3. HR sends the Welcome Pack email to the new hire containing: Day 1 logistics, required documents, benefits enrolment information, and company handbook.
4. Assign an Onboarding Buddy from the same team — someone who joined within the last 6-18 months and can share recent firsthand onboarding experience.
5. Hiring Manager prepares the 30-60-90 Day Plan with clear milestones and expectations for each phase.

**Directive:** No new employee should arrive on Day 1 without a functioning laptop, email access, and a scheduled first-week calendar. A poor Day 1 experience damages trust that takes months to rebuild.

**Knowledge:** Our internal surveys show that new hires rate their onboarding experience at 4.1/5.0 overall. The lowest-scoring element is "clarity of role expectations in the first month" (3.4/5.0), which is why the 30-60-90 plan is now mandatory.

---

## Month 1: Foundation (Days 1-30)

### Week 1 — Orientation Playbook
...
**Principle:** The first 30 days form the employee's mental model of the company. Every interaction, every process, every moment of confusion or clarity shapes how they'll approach their work for years. We invest in onboarding because first impressions compound.

---

## Month 2-3: Acceleration (Days 31-90)

### Month 2 — Contribution Playbook
...
**Directive:** If any concerns emerge during the 90-day period — performance, cultural fit, or role misalignment — they must be documented and addressed immediately with an Improvement Plan. Waiting until the 90-day review to raise concerns is too late.
...
### Self-Assessment & Manager Review Playbook
...
**Directive:** Preliminary ratings must be supported by specific examples and evidence. Ratings of "Exceptional" or "Below Expectations" require at least 3 documented examples. No rating may be assigned based on a single data point or recency bias.

**Knowledge:** Our current performance distribution is: Exceptional 8%, Exceeds Expectations 25%, Meets Expectations 52%, Developing 12%, Below Expectations 3%. We do not force a distribution curve, but deviations >10% from this pattern at the department level trigger a calibration discussion.

---

## Calibration

### Calibration Session Playbook
...
**Directive:** Calibration sessions are confidential. Individual employee discussions, ratings, and deliberations must not be shared beyond the calibration participants. Breaches of calibration confidentiality are treated as a serious conduct issue.

**Principle:** Fairness requires comparison. A manager can only assess their team fairly when they see how their assessments stack up against the broader organisation. Calibration isn't about politics — it's about equity and consistency.

---

## Review Delivery & Development Planning

### Review Conversation Playbook
...
**Directive:** Performance reviews must never be the first time an employee hears about a performance concern. If a manager delivers unexpected negative feedback during a review, this indicates a management failure, not an employee failure. Ongoing feedback is a non-negotiable management responsibility.

**Principle:** Performance management is not a biannual event — it's a continuous relationship between manager and employee. The formal review is simply the checkpoint that documents what both parties should already know. The real work happens in the weekly 1-on-1s, real-time feedback, and daily coaching moments.
...
**Directive:** Job descriptions must focus on outcomes and competencies, not credentials. Replace "requires 10 years of experience" with "has led cross-functional initiatives at scale." Experience thresholds disproportionately exclude diverse candidates without predicting performance.

**Knowledge:** Roles with structured scorecards and pre-defined competencies have 40% less interviewer disagreement and 28% faster decision-making. Our average time-to-fill is 42 days for individual contributors and 65 days for manager-level roles.
...
**Directive:** All interviewers must use the standardised scorecard and submit their assessment before seeing other interviewers' scores. This prevents anchoring bias and ensures independent evaluation.

**Directive:** Interview questions must be consistent across candidates for the same role. Interviewers may ask follow-up questions based on responses, but the core question set remains the same for fairness.

**Principle:** We hire for trajectory, not just track record. Someone who has demonstrated rapid growth, intellectual curiosity, and resilience will outperform someone with an impressive resume and a fixed mindset. Look for the learning curve, not just the current position.
...
**Knowledge:** Our offer acceptance rate is 82%. The top 3 reasons candidates decline are: competing offer with higher compensation (45%), location/flexibility concerns (30%), and role scope misalignment (15%). Offers delivered within 48 hours of decision have a 91% acceptance rate vs. 72% for offers delivered after 5+ days.

**Directive:** Counter-offers are evaluated on a case-by-case basis by the Hiring Manager and HR together. We will match within our compensation band but will not engage in bidding wars. If we can't compete on salary, we differentiate on growth opportunity, team, and mission.`,
  },
...
**Directive:** All onboarding plans must include a "Risk Register" section listing at least 3 identified risks with mitigation strategies.
...
**Directive:** Production data migration must never proceed without a validated rollback plan approved by the Solutions Engineering Lead.

---

## Phase C: Training & Go-Live

### C.1 — Training & Enablement
...
**Knowledge:** Post-training satisfaction target: >4.2/5.0. Clients with training scores below 3.8 require a follow-up reinforcement session within 10 business days.
...
**Directive:** The Onboarding Lead must remain available for escalations for 15 business days after handoff.

**Principle:** Onboarding quality is the single strongest predictor of long-term retention. Every hour invested returns 10x in reduced support burden and increased expansion revenue.

**Knowledge:** Our NPS benchmark for enterprise onboardings is +62. Current quarterly average: +58. Analysis of 127 onboardings shows that clients completing all four phases within target have 2.3x higher expansion revenue at 18 months.`,
  },
  {
...
**Directive:** SLA timers begin at ticket creation, not at first response. A ticket that receives a quick acknowledgment but no meaningful progress is still subject to resolution SLAs.

**Directive:** Enterprise clients with Premier Support contracts receive priority queuing: all SLAs are 50% tighter and Tier 2 is the entry point (no Tier 1 routing for Premier accounts).

**Knowledge:** Our current SLA compliance rates are: Tier 1 first response 96%, Tier 1 resolution 91%, Tier 2 first response 93%, Tier 2 resolution 84%, Tier 3 acknowledgment 89%. Our target across all tiers is >95%. Tier 2 resolution is our weakest metric, primarily driven by complex integration issues.
...
**Directive:** Customers must never be asked to re-explain their issue after an escalation. The receiving tier must review all prior communications and demonstrate understanding before engaging the customer.

**Principle:** Every escalation is a signal that our product, process, or people need improvement. We track escalation patterns not to manage workload, but to identify and eliminate the root causes that create the need for escalation in the first place.
...
**Knowledge:** Tickets with proactive daily updates receive satisfaction scores 1.4 points higher (on a 5-point scale) than tickets where the customer had to ask for updates. Our overall support CSAT is 4.2/5.0. The strongest driver of support satisfaction is "felt informed throughout the process," not resolution speed.`,
  },
  {
    id: "cs-qbr-playbook",
    title: "Quarterly Business Review Playbook",
    subtitle: "How CSMs prepare, deliver, and follow up on strategic customer reviews",
    domain: "Customer Success",
    icon: "heart-handshake",
    wordCount: 750,
    content: `# Quarterly Business Review Playbook

## Overview
The Quarterly Business Review is our primary strategic touchpoint with clients. It's where we demonstrate value delivered, align on future priorities, and identify expansion opportunities. This playbook ensures every QBR is consistently excellent.
...
**Directive:** A QBR must never be a one-way data dump. Maximum 40% of the meeting should be presentation; 60% should be discussion. If you're talking more than listening in a QBR, you're doing it wrong.

**Knowledge:** Clients who attend QBRs consistently (4 per year) have 45% higher renewal rates and 2.1x higher expansion revenue compared to clients with sporadic QBR attendance. The most common reason clients skip QBRs is "didn't see value in previous sessions."

---

## Delivery

### QBR Execution Playbook
...
**Principle:** The best QBR leaves the client thinking "these people understand my business." It's not about our platform — it's about their outcomes. Every slide, every metric, every recommendation should be framed through the lens of what matters to them, not what matters to us.
...
**Directive:** QBR follow-up is non-negotiable. A QBR without follow-through is worse than no QBR at all — it teaches the client that our commitments are unreliable. Every action item must be tracked, completed, and communicated.

**Knowledge:** CSMs who send the QBR summary within 24 hours see 30% higher action item completion rates from both sides compared to summaries sent after 3+ days. The most impactful QBR element, rated by clients, is "concrete action plan with clear ownership."`,
  },
];
